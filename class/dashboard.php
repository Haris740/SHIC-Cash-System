...
<html lang="en">
  <head>
    ...
    <title>SHIC Cash System|||Dashboard</title>
    <!-- plugins:css -->
                    ...
                    <div class="row report-inner-cards-wrapper">
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          <?php 
                        $sql2 ="SELECT * from  tblstudent WHERE StudentClass=$cid";
...
?>
                          <span class="report-title">Total Class Cash List</span>
                          <h4><?php echo htmlentities($totnotice);?></h4>
                          <a href="manage-cash-list.php"><span class="report-count"> View Cash List</span></a>
                        </div>
