...
<html lang="en">
  <head>
    ...
    <title>SHIC Cash System|||Manage Students</title>
    <!-- plugins:css -->
...
$sql="SELECT tblstudent.StuID,tblstudent.ID as sid,tblstudent.StudentClass,tblstudent.StudentName,tblstudent.DateofAdmission,tblclass.ClassName from tblstudent join tblclass on tblstudent.StudentClass = tblclass.ID where tblstudent.StudentClass=$cid LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
