...
<html lang="en">
  <head>
    ...
    <title>SHIC Cash System|| Profile</title>
    <!-- plugins:css -->
...
{               ?>
                      <div class="form-group">
                        ...
                        <input type="text" name="adminname" value="<?php  echo $row->ClassName;?>" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="exampleInputCity1">Class Registration Date</label>
                         <input type="text" name="" value="<?php  echo $row->ClassRegdate;?>" readonly="" class="form-control">
                      </div><?php $cnt=$cnt+1;}} ?> 
